...
abstract class CValidator extends CComponent
{
	...
	public $safe=true;
	/**
	 * @var boolean whether to perform client-site validation. Defaults to true.
	 * Please refer to {@link CActiveForm::enableClientValidation} for more details about client-site validation.
	 * @since 1.1.7
	 */
	...
	/**
	 * Returns the JavaScript needed for performing client-site validation.
	 * Do not override this method if the validator does not support client-site validation.
	 ...
	 * @param CModel $object the data object being validated
	 * @param string $attribute the name of the attribute to be validated.
	 * @return string the client-site validation script. Null if the validator does not support client-site validation.
