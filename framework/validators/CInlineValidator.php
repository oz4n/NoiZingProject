...
class CInlineValidator extends CValidator
{
	...
	/**
	 * Returns the JavaScript code needed to perform client-site validation by calling the {@link clientValidate} method.
	 ...
	 * @return string the client-site validation script.
