 ...
 * For example, the URL <code>http://dashboard.example.com/en/profile</code> may be parsed into GET parameters
 * <code>user=dashboard</code> and <code>lang=en</code>. On the other hand, rules with hostname may also be used to
