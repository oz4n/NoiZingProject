...
class CFormInputElement extends CFormElement
{
	...
	/**
	 * @var boolean whether to allow client-site validation for this input. Note that in order to use
	 * client-site validation, {@link CForm::activeForm} must be configured with 'enableClientValidation'=>true.
	 * This property allows turning on or off  client-site validation for individual input fields.
	 * Defaults to true.
	 * @since 1.1.7
	 */
