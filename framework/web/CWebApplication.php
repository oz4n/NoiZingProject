...
class CWebApplication extends CApplication
{
	 ...
	 * the corresponding controller. For example, if the route is "dashboard/user/create",
	 * then the controller will be created using the class file "protected/controllers/dashboard/UserController.php".</li>
	 * </ol>
