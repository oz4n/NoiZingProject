...
//require_once 'OAuth/Storage/Encrypter.php';
//require_once 'OAuth/Storage/StorageInterface.php';
//require_once 'OAuth/Storage/Session.php';
//require_once 'OAuth/Storage/DPDO.php';
//require_once 'OAuth/Consumer/ConsumerAbstract.php';
//require_once 'OAuth/Consumer/Curl.php';
/**
...
class API {
     ...
     */
    public function __construct(ConsumerAbstract $OAuth, $root = 'sandbox') {
        $this->OAuth = $OAuth;
        $this->setRoot($root);
    }
     ...
     * The link returned is for a preview pages from which the user an choose to
