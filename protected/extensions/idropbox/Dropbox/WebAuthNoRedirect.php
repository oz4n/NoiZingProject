...
{
    /**
     * Returns the URL of the authorization pages the user must visit.  If the user approves
     * your app, they will be shown the authorization code on the web pages.  They will need to
