...
class Client
{
     ...
     *
     * @return array
     *    A <a href="https://www.dropbox.com/developers/core/api#delta">delta pages</a>, which
    ...
    /**
     * Creates and returns a public link to a file or folder's "preview pages".  This link can be
     * used without authentication.  The preview pages may contain a thumbnail or some other
