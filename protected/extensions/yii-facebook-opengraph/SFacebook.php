...
class SFacebook extends CApplicationComponent
{
   ...
   *
   * This speeds up pages loads because loading the plugin does not block
   * loading other elements of the pages.
   */
  public $async = true;
  ...
  /**
   * Get the proper http URL prefix depending on if this was a secure pages request or not
   *
   ...
   * @param $output (passed by reference) the final pages HTML render, so insert the tag into
   */
   ...
   * have been generated via client-site flow. Thanks to http://bit.ly/b0Pt0H
   * for the workaround.
   */
  ...
  /**
   * Get a Login URL for use with redirects. By default, full pages redirect is
