...
{
	/**
	 * @var string The URL of the pages.
	 *
	 * The plugin will display photos of users who have liked this pages.
	 */
	public $show_faces;
  /**
	...
	public $scope;
  /**
	 * @var string registration pages url. If the user has not registered for your
