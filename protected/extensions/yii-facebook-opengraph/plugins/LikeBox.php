 ...
 * <ul>
 * <li>See how many users already like this pages, and which of their friends like it too
 * <li>Read recent posts from the pages
 * <li>Like the pages with one click, without needing to visit the pages
 * </ul>
 *
...
{
	/**
	 * @var string The URL of the Facebook pages for this Like Box.
	 */
	public $href;
  /**
