...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'term_id',array('size'=>45,'maxlength'=>45)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'term_taxonomy_id'); ?>
		<?php echo $form->textField($model,'term_taxonomy_id'); ?>
	</div>
