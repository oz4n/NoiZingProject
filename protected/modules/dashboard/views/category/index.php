    ...
    <div class="container">
        <div class="row-fluid"> 
            <div class="span4">
                ...
                <div class="control-group">                                   
                    <div class="controls">
                        <?php echo $form->dropDownListRow($category, 'parent', TermTaxonomy::loadCategorys("category"), array('encode' => false, 'class' => 'span6', 'id' => 'drop-category-list')); ?>
            ...
            <div class="span8">               
                <?php $this->widget('bootstrap.widgets.TbGridView', $category->dataCategoryStore()); ?>  
