...
class PostCategoryController extends AdminController {
    ...
    public function init() {
        ...
        Yii::app()->CInfo->setTrue_save_info('Post Category');
        Yii::app()->CInfo->setFalse_save_info('Post Category');
        Yii::app()->CInfo->setTrue_delete_info('Post Category');
        Yii::app()->CInfo->setFalse_delete_info('Post Category');
    }
...
//            ),
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Term'])) {
            ...
            $category->termTaxonomies = array(array('type'=>'page_category','parent' => $_POST['Term']['parent'], 'description' => $_POST['Term']['description'], 'status' => $_POST['Term']['status']));
