<?php
echo CHtml::link('<i class="not-white-users"></i>', "", array('id' => 'pop-users', 'style' => 'cursor: pointer;'));
echo CHtml::Link($comment != null ? '<i class="not-red-comments" id="not-red"></i>' : '<i class="not-white-comments"></i>', "", array('id' => 'pop-comments', 'style' => 'cursor: pointer;'));
echo CHtml::link('<i class="not-white-globe"></i>', "", array('id' => 'pop-setting', 'style' => 'cursor: pointer;'));
?>
