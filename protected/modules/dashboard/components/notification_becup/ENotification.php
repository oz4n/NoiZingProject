...
class ENotification extends CWidget {
    ...
    public static function actions() {
        parent::actions();
        return array(
            'actionMsg' => 'dashboard.components.notification.actions.actionNotification'
        );
    }
        ...
        /* Global Message notification js generet */
         Yii::app()->clientScript->registerScript('script-function', '
                 ...
                 function EditFadein(cmid,parentid){
                    ...
                    $("#form-action-"+cmid).attr("action","' . Yii::app()->request->hostInfo . Yii::app()->baseUrl . '/index.php/dashboard/comment/message.actionMsg/id/"+cmid);
                 ...
                 function ReplayFadein(cmid){
                    ...
                    $("#textarea-"+cmid).val(" ");
                    $("#form-replay-"+cmid).fadeIn("slow"); 
                    $("#form-action-"+cmid).attr("action","' . Yii::app()->request->hostInfo . Yii::app()->baseUrl . '/index.php/dashboard/comment/message.actionMsg' . '");
                 ...
                 function Approve(cmid){
                    ...
                    $.ajax({
                        type: "POST",
                        "dataType":"json",
                        url: "' . Yii::app()->request->hostInfo . Yii::app()->baseUrl . '/index.php/dashboard/comment/message.actionMsg/id/" + cmid,
        ...
        Yii::app()->clientScript->registerScript('script-comments-not', ' 
            ...
            if($("#pop-comments-show").is(":hidden")){
                    ...
                    jQuery.ajax({
                        ...
                        "dataType":"json",
                        data:{action:"allmsg"},
                        "url":"' . Yii::app()->request->hostInfo . Yii::app()->baseUrl . '/index.php/dashboard/comment/message.actionMsg",
