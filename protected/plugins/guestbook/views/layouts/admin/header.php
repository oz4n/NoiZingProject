<div id="header">
    <div class="container">
        ...
        <?php
        $menu = array(
            array('icon' => 'home', 'label' => '', 'url' => array('/dashboard/default/index'), 'itemOptions' => array('class' => 'nav-icon')),
            array(
                'icon' => 'icon-user',
                'label' => 'Accounts',
            ...
            array('label' => 'Articles',
                ...
                'items' => array(
                    array('icon' => 'th-list', 'label' => 'All Articles', 'url' => array('/dashboard/post/index')),
            ...
            array(
                ...
                'items' => array(
                    array('icon' => 'th-list', 'label' => 'All Pages', 'url' => array('/dashboard/pages/index')),
                    array('icon' => 'plus', 'label' => 'Add New', 'url' => array('/dashboard/pages/create')),
                    '---',
                    array('icon' => 'list-alt', 'label' => 'Pages Categories', 'url' => array('/dashboard/pagecategory/index')),
                )
            ),
                ...
                'items' => array(
                    array(
                        ...
                        'items' => array(
                            ...
                            array('icon' => 'filter', 'label' => 'Menus', 'url' => array('/dashboard/menu/index')),
