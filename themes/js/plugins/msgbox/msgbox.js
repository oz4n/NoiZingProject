                ...
                this.esqueleto.msgbox.queue(this.options.name, $.proxy(function (c) {
                    ...
                    if (h.type != 'prompt') {
                        $.each(d, $.proxy(function (i, a) {
                            if (a.type == 'submit') {
                                this.esqueleto.buttons.append($('<button type="submit" class="msg-btn">' + a.value + '</button>').bind('click', $.proxy(function (e) {
                                    this.close(a.value);
                                    e.preventDefault()
                                },
                                this)))
                            } else if (a.type == 'cancel') {
                                this.esqueleto.buttons.append($('<button type="button" class="msg-btn">' + a.value + '</button>').bind('click', $.proxy(function (e) {
                                    this.close(false);
                                    e.preventDefault()
                                },
                                this)))
