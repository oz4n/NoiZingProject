...
;(function($){
	...
	$.fn.bxSlider = function(options){
		...
		/**
		 * Returns the number of pages (one full viewport of slides is one "pages")
		 */
		...
		var resizeWindow = function(e){
			...
			if(windowWidth != windowWidthNew || windowHeight != windowHeightNew){
				...
				// if the active index (pages) no longer exists due to the resize, simply set the index as last
		...
		el.goToNextSlide = function(){
			// if infiniteLoop is false and last pages is showing, disregard call
